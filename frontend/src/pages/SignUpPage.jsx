        ...
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <button
            ...
            className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4
						focus:ring-[#24292F]/50 font-medium rounded-lg flex gap-2 p-2 items-center w-full  justify-center"
          >
          ...
          <p className="text-gray-300">
            Signing up is necessary to enjoy the App's complete functionality..
            <span>
